...
<body>
   <?php include("header.php");?>
	<div id="page" class="page"  style=" background-color:#ADD8E6!important;">            
            <section class="padding-110px-tb bg-dark-white builder-bg xs-padding-60px-tb border-none" id="contact-section">
                <div class="container">
                    <div class="row">
                        <!-- section title -->
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <h2 class="section-title-large sm-section-title-medium xs-section-title-large text-yellow font-weight-600 alt-font tz-text margin-ten-bottom xs-margin-fifteen-bottom"> We are Coming Soon with  ....  LMA Class Rooms</h2>
                        </div>
                        <!-- end section title -->
                    </div>
                   <!-- <div class="row">
