                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <h2 class="section-title-large sm-section-title-medium xs-section-title-large text-yellow font-weight-600 alt-font tz-text margin-ten-bottom xs-margin-fifteen-bottom">Testimonial</h2>
                        </div>
                        <!-- end section title -->
                    </div>
                    <div class="row">
	                ...
	                ?>
                       <div class="col-md-6 lf">
                        <h5 align="center"><strong><?php echo $QD->name;?></strong></h5><br>
                        <p  align="justify">
                    ...
                    <img src="testimonial/<?php echo $QD->image; ?>"  width="300" border="0" >
                    </div>
                    <?php } ?>
                  </div>
