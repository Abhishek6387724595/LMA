...
if(isset($_POST['submit']))
      {
	        $duplicate=mysqli_query($connect,"select * from test where test_name='".$_POST['test']."'");
	        if (mysqli_num_rows($duplicate)>0)
	          {
		        $statusMsg = "Already exit record Database!";
		        echo '<script>alert("'.$statusMsg.'");</script>';
			}else{
			$insert = "INSERT INTO test(test_name)VALUES('".$_POST['test']."')";
                            ...
                            <div class="card-body card-block">
                                <form action="#" method="post"  class="form-horizontal">
									 ...
									 <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text"  id="test" name="test"></div>
                                    </div>
