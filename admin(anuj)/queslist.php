...
<?php
				    $counter=1;
					$flag=1;
				    $Query="select * from question where test_name='".$_REQUEST['test']."'";
			 ...
			 ?>
						...
						<i class="ace-icon fa fa-pencil bigger-120"></i></a>
													<br><br>-->		
                                                            <a class="btn btn-xs btn-danger" href="delques.php?id=<?php echo $QD->id; ?>" onClick="return confirm('This will permanently remove this <?php echo $QD->id; ?>. Do you want to continue?');" title="Delete">
