<aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-cog"></i><a href="conducttest.php">Conduct Test</a></li>
                ...
                <li><i class="menu-icon fa fa-cog"></i><a href="manage_carousal.php"> Manage Carousel</a> </li>
                ...
                <!--end changes-->
                            ...
                            <li><i class="menu-icon fa fa-cog"></i><a href="manage_testimonial.php">Manage Testimonial</a></li>
