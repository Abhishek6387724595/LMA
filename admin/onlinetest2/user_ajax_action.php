			...
			foreach($result as $row)
			{
				...
				foreach($sub_result as $sub_row)
				{
					...
					<div class="col-md-6" style="margin-bottom:32px;">
						<div class="radio">
							<label><h4><input type="radio" name="option_1" class="answer_option" onclick=
								"document.getElementById(data-id).checked = true;" data-question_id="'.$row["question_id"].'" data-id="'.$count.'"/>&nbsp;'.$sub_row["option_title"].'</h4></label>
						</div>
					</div>
					';
