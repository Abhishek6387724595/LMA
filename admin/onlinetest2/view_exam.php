...
<div class="row">
	<div class="col-md-8">
		<div class="card">
			<div class="card-header">Online Exam</div><br>
			<div class="row">
				<div class="col-md-8">
				<!-- <button type="submit" class="btn btn-warning" style="height:50px; width:80px"></button>
					<button type="submit" class="btn btn-warning" style="height:50px; width:80px">Maths</button>
					<button type="submit" class="btn btn-warning" style="height:50px; width:80px">Science</button>
					<button type="submit" class="btn btn-warning" style="height:50px; width:80px">GK</button> -->
				<?php
					$exam->query = "
									SELECT course_name FROM question_table 
									WHERE online_exam_id = '".$exam_id."'
						...
						foreach($result as $row)
						{
					 	...
					 	$exam->query = "
										SELECT subject_name FROM course_detail 
						...
						{
						?>
							<button type="submit" class="btn btn-warning" style="height:50px; width:80px"><?php echo $row['subject_name'];?></button>
						<?php
						}
					?>
