    	...
    	<form method="post" id="exam_form">
      		<div class="modal-content">
        		...
        		<div class="modal-body">
          			...
          			<!-- <div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">Select<span class="text-danger">*</span></label>
	              			<div class="col-md-8">
					  ...
					  <!-- <div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">Marks for wrong question<span class="text-danger">*</span></label>
	              			<div class="col-md-8">
  	...
  	<div class="modal-dialog modal-lg">
    	<form method="post" id="question_form">
      		<div class="modal-content">
				...
				<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">Exam<span class="text-danger">*</span></label>
	              			<div class="col-md-8">
	                			<select name="course_name" id="course_name" class="form-control">
	                				<option value="">Select</option>
	                				<option value="NDA">NDA</option>
	                				<option value="CDS">CDS</option>
	                				<option value="SCI">NAVY</option>
