...

{
...

	{
		...
		$this->database = 'lamilitaire_org';

		$this->home_page = 'https://localhost/online_examination';
...

	{
		...
		$mail->From = 'avasthiabhishek0033@gmail.com';



		$mail->FromName = 'avasthiabhishek0033@gmail.com';
...

	{
		...
		$this->query = "SELECT * FROM user_exam_enroll_table INNER JOIN online_exam_table ON 

		online_exam_table.online_exam_id = user_exam_enroll_table.exam_id WHERE user_exam_enroll_table.user_id = '$user_id'
