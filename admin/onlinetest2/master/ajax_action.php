...
if(isset($_POST['page']))
{
	...
	if($_POST['page'] == 'exam')
	{
		if($_POST['action'] == 'fetch')
		{
			...
			$exam->query = "
			SELECT * FROM online_exam_table WHERE admin_id = '".$_SESSION["admin_id"]."' AND (";
		...
		if($_POST['action'] == 'Add')
		{
			...
			$output = array('success'	=>	'New Exam Details Added');
		...
		if($_POST['action'] == 'edit_fetch')
		{
			...
			foreach($result as $row)
			{
				...
				$output['online_exam_status'] = $row['online_exam_status'];
		...
		if($_POST['action'] == 'Edit')
		{
			...
			SET online_exam_title = :online_exam_title, online_exam_datetime = :online_exam_datetime, online_exam_duration = :online_exam_duration, total_question = :total_question,  online_exam_status = :online_exam_status, marks_per_right_answer = :marks_per_right_answer, marks_per_wrong_answer = :marks_per_wrong_answer   
...
// 					':option_number'	=>	$count,
// 					':option_title'		=>	$exam->clean_data($POST['option_title' . $count])
// 				);
...
// 	}
	...
	if($_POST['page'] == 'question')
	{
		if($_POST['action'] == 'Add')
		{
			...
			$exam->query = "
			INSERT INTO question_table 
			(subject_name, online_exam_id, course_name, question_title, answer_option) 
			VALUES (:subject_name, :online_exam_id, :course_name, :question_title, :answer_option)
			";
