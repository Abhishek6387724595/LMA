	...
	<div class="containter">
		<div class="d-flex justify-content-center">
			...
			<div class="card1" style="margin-top:50px;margin-bottom: 100px;">
                ...
                <a href="http://snarwebprojects.000webhostapp.com/">Back To Home</a><br><br><br><br>
              </div>
        		</div>
      		</div>
      		<br /><br />
